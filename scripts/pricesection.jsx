			...
			<div className="pcontent">
				<table className="table">
					...
					<tr>
                        ...
                        services with a twist; you are regularly consulted for weekly articles so that the content properly represents your trade and your business. 
						In addition, each article is written with an accompanying JavaScript function (interactive tutorial/demonstration, calculator, etc) to ensure that your content is unique, interesting, and quality. At the end of 
